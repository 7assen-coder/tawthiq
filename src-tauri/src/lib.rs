...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::auth::apply_recovery_code,
            commands::auth::apply_temp_reset,
            commands::auth::has_admin_master_pin,
            commands::auth::setup_admin_master_pin,
            commands::auth::verify_admin_master_pin,
            commands::auth::admin_session_lock,
            commands::auth::admin_session_active,
            commands::auth::generate_temp_reset,
            commands::auth::export_access_policy_json,
            commands::auth::lock_session,
            commands::auth::get_app_version,
            commands::access::check_access,
            commands::access::get_install_id,
            commands::access::get_public_install_id,
            commands::access::get_support_contact,
